...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  qishuiFetchRecommend: () => ipcRenderer.invoke('qishui-fetch-recommend'),
  qishuiFetchRecommendClose: () => ipcRenderer.invoke('qishui-fetch-recommend-close'),
  qishuiOpenScrapeWindow: () => ipcRenderer.invoke('qishui-open-scrape-window'),
  qishuiScrapeSongs: () => ipcRenderer.invoke('qishui-scrape-songs'),
  qishuiCloseScrapeWindow: () => ipcRenderer.invoke('qishui-close-scrape-window'),
